...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../index.html">Prevel</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="../mytrip.html">Passport</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="/FindCrew/FindCrew.html">Findcrew</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="intro-heading text-uppercase">R e v i e w</h2>
            <hr>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" href="review">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fas fa-plus fa-3x"></i>
                </div>
              </div>
              <div class="img-fluid create" alt="" ></div>
            </a>
            <div class="portfolio-caption">
              <h4>New trip</h4>
              <p class="text-muted">You can write your own trip here</p>
            </div>
